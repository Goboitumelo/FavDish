package com.goboitumelo.apps.favdish.view.activities
...
import com.goboitumelo.apps.favdish.R
import com.goboitumelo.apps.favdish.application.FavDishApplication
import com.goboitumelo.apps.favdish.databinding.ActivityAddUpdateDishBinding
import com.goboitumelo.apps.favdish.databinding.DialogCustomImageSelectionBinding
import com.goboitumelo.apps.favdish.databinding.DialogCustomListBinding
import com.goboitumelo.apps.favdish.model.entities.FavDish
import com.goboitumelo.apps.favdish.utils.Constants
import com.goboitumelo.apps.favdish.view.adapters.CustomListItemAdapter
import com.goboitumelo.apps.favdish.viewmodel.FavDishViewModel
import com.goboitumelo.apps.favdish.viewmodel.FavDishViewModelFactory
import java.io.File
...
/**
 * A screen where we I add and update the dishes.
 */
    ...
    override fun onClick(v: View) {
        ...
        when (v.id) {
            ...
            R.id.btn_add_dish -> {
                ...
                // For Dish Image i have the global variable defined already.
